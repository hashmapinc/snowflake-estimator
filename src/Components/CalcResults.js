        ...
        if (this.props.med_calc_results) {
              return <Container fluid id="overlay" className="w-100 h-100">
                          <div id="overlay_content" className="position-relative col-lg-10 order-sm-1 mx-auto">
                                <h2 className="credits">We estimate an average credit usage rate of about {(12*Math.round(this.props.med_calc_results/12)).toLocaleString()} credits annually or {Math.round(this.props.med_calc_results/12).toLocaleString()} credits every month.</h2>
