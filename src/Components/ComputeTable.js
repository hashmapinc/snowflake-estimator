...
//                     <Col>
//                         <Button variant="outline-primary" size="sm" onClick={this.handleAddRow}>Add Row</Button>
//                     </Col>
...
//                                 </tr>
//                             </thead>
//                             <TableData row_data={this.state.row_data} warehouse_values={this.state.warehouse_values}/>
//                         </Table>
//                     </Col>
//                 </Row>
//             </Container>
